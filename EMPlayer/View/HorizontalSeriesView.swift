//
//  HorizontalSeriesView.swift
//  EMPlayer
//
//  Created by sonson on 2025/03/15.
//
...
struct HorizontalSeasonView: View {
    ...
    @StateObject var contentModel: HorizontalSeasonModel
    
    init(controller: HorizontalSeasonModel) {
...
struct HorizontalSeriesView: View {
    @EnvironmentObject var appState: AppState
    
    @StateObject var contentModel: HorizontalSeriesModel
    
    init(controller: HorizontalSeriesModel) {
        _contentModel = StateObject(wrappedValue: controller)
    }
        ...
        ScrollView(.vertical, showsIndicators: true) {
            VStack(spacing: 20) {
                ForEach(contentModel.seasons, id: \.id) { season in
                    let controller = HorizontalSeasonModel(currentItem: season, appState: appState)
...
#Preview {
    ...
    let controller = HorizontalSeriesModel(currentItem: BaseItem.dummy, appState: appState)
    HorizontalSeriesView(controller: controller).environmentObject(appState)
